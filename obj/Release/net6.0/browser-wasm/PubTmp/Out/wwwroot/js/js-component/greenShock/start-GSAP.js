function gaspStartInit() {
    console.log('Entered gaspInit!');
    var tl = gsap.timeline({ repeat: 30, repeatDelay: 1 });
    tl.to(".box", { duration: 1, x: 300 });
    tl.to(".orange", { duration: 1, scale: 2, skewX: 45, rotation: 180 });
    tl.to(".grey", { duration: 1, rotation: 360 });
    tl.to(".green", { duration: 1, rotation: 360, scale: 0.2 });
}
...
function mouseFollower() {
    ...
    //Balok-Hide
    var balokHide = document.querySelector('.balok');
    var balokScale = document.querySelector('.balok2');
    ...
    function hoverFunc(e) {
        timeLine.to(ball, 0.1, {
            background: "white",
            border: "none",
            width: "20px",
            height: "20px",
        });
        timeLine.to(balokHide, 0.1, {
            background: "black"
        })
    }
    ...
    function hoverScale(e) {
        timeLine.to(ball, 0.3, { scale: 3.5, background: "green", ease: "rough" });

    }

    function unhoverScale(e) {
        timeLine.to(ball, 0.3, {
            scale: 1,
            background: "red"
        });
    }
    ...
    balokHide.addEventListener("mouseenter", hoverFunc);
    balokHide.addEventListener("mouseleave", unhoverFunc);

    balokScale.addEventListener("mouseenter", hoverScale);
    balokScale.addEventListener("mouseleave", unhoverScale);


}

function scrollTriggerTest() {
    console.log("Entered scrollTriggerTest!");
    //RegisterPlugin
...
function textAnimation() {
    console.log("Entered textAnimation");
    // SELECTING...
    // T
    ...
    if (a1.points[0]) {
        ...
        aline
            .to(apoly, 0.2, {
                x0: 305.6, y0: 138.6, x2: 305.6, y2: 138.6, ease: Quad.easeIn, onUpdate: function () {
                    updatePolyline(a1, apoly);
                }
            }, 0)
            .to(apoly, 0.5, {
                x0: 282.6, x2: 330.6, ease: Back.easeOut, onUpdate: function () {
                    updatePolyline(a1, apoly);
                }
            }, 'a1');
    }
    ...
    if (n1.points[1]) {
        ...
        nline
            .to(npoly, 0.2, {
                y1: 51.6, y3: 51.6, ease: Quad.easeOut, onUpdate: function () {
                    updatePolyline(n1, npoly);
                }
            }, 0)
            .to(npoly, 0.2, {
                x2: 391.6, x3: 391.6, y2: 138.6, y3: 62.4, ease: Quad.easeOut, onUpdate: function () {
                    updatePolyline(n1, npoly);
                }
            }, 0.2);
    }
    ...
    if (k2.points[0]) {
        ...
        kline
            .to(kpoly, 0.2, {
                x0: 452.6, y0: 51.6, x2: 452.6, y2: 145.6, ease: Back.easeOut, onUpdate: function () {
...
function fadeScrollTrigger() {
    console.log("Enter fadeScrollTriger");
    ...
    gsap.set('.title-3', { y: 200 })

    tl.to('.title-2', { duration: 0.1, opacity: 1, scale: 1, y: 0 })
        .to('.title-3', { duration: 0.1, opacity: 1, scale: 1, y: 0 }, "-=0.2")
}

function fadeContainerScroll() {
